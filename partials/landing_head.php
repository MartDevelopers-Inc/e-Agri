...
?>
    ...
    <head>
        ...
        <!-- Favicons
		================================================== -->
        <link rel="shortcut icon" href="../public/backend_assets/images/neptune.png">

        <!-- Critical styles
		================================================== -->
        <link rel="stylesheet" href="../public/landing_assets/css/critical.min.css" type="text/css">
        ...
        <script type="text/javascript" src="../public/landing_assets/js/device.min.js"></script>
    </head>
<?php } ?>