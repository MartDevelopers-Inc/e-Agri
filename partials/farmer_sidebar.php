    ...
    <div class="app-sidebar">
        ...
        <div class="app-menu">
            <ul class="accordion-menu">
                ...
                <li>
                    <a href="farmer_products"><i class="material-icons-two-tone">redeem</i>Agri Products</a>
                </li>
                <li>
                ...
                <li>
                    <a href="farmer_payments"><i class="material-icons-two-tone">price_check</i>Payments</a>
                </li>
                <li>
                    <a href="farmer_reports"><i class="material-icons-two-tone">card_membership</i>Reports</a>
                </li>
                <li>
                    <a href="farmer_blogs"><i class="material-icons-two-tone">edit_note</i>Blogs</a>
                </li>
                <li>
