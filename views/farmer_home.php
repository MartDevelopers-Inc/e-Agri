...
require_once('../partials/farmer_analytics.php');
checklogin();
                                            ...
                                            ?>
                                                <li class="widget-list-item widget-list-item-green">
                                                    ...
                                                    <span class="widget-list-item-description">
                                                        <a href="farmer_successful_checkouts" class="widget-list-item-description-title">
                                        ...
                                        <ul class="widget-list-content list-unstyled">
                                            ...
                                            ?>
                                                <li class="widget-list-item widget-list-item-green">
                                                    ...
                                                    <span class="widget-list-item-description">
                                                        <a href="farmer_payments" class="widget-list-item-description-title">
