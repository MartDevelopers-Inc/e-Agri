...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->sys_name . ' |  Customers Report Generated On ' . date('d, M Y') . '</i>
            </div>
            ...
            <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
                ...
                ';
                    ...
                    <tr>
                        ...
                        <td width="100%">' . $users->user_idno . '</td>
                        <td width="90%">' . $users->user_phone_no . '</td>
                        <td width="90%">' . $users->user_email . '</td>
                        <td width="90%">' . $users->user_created_at . '</td>
                    </tr>
                    ';
                    $cnt = $cnt + 1;
                }
    ...
    $dompdf->render();
    $dompdf->stream('Customers', array("Attachment" => 1));
