...
if (isset($_POST['Update_Profile'])) {
    ...
    $query = 'UPDATE users SET user_name =?, user_email =?, user_phone_no =?, user_idno =?, user_bio =?  WHERE user_id = ?';
...
if (isset($_POST['Update_profile_pic'])) {
    ...
    $img_1 = explode(".", $_FILES['user_dpic']["name"]);

    /* Give New File Names */
    $new_img_1 = $sys_img_code_alpha . '.' . end($img_1);

    /* Move Uploaded Images */
    move_uploaded_file($_FILES["user_dpic"]["tmp_name"], "../public/backend_assets/images/avatars/" . $new_img_1);

    /* Persist Changes */
    $update = "UPDATE users SET user_dpic =? WHERE user_id = ?";
                                ...
                                <div class="col">
                                    <div class="page-description page-description-tabbed">
                                        ...
                                        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="prfile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="security" aria-selected="false">Profile Picture</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="row m-t-lg">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <label for="settingsPhoneNumber" class="form-label">Farmer Biography</label>
                                                                    <textarea rows="5" type="text" required name="user_bio" class="form-control"><?php echo $user->user_bio; ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="row m-t-lg">
                                                                <div class="col ">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row m-t-xxl">
                                                            <div class="col-md-12">
                                                                <label for="settingsNewPassword" class="form-label">New Profile Picture</label>
                                                                <input type="file" required accept=".png, .webp, .jpg, .jpeg" name="user_dpic" class="form-control" aria-describedby="settingsNewPassword">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row m-t-lg">
                                                            <div class="col">
                                                                <input type="submit" name="Update_profile_pic" value="Update" class="text-right btn btn-primary m-t-sm" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
