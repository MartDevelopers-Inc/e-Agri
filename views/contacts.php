...
<body>
    <div id="app">
        ...
        while ($sys = $res->fetch_object()) { ?>
            ...
            <!-- start hero -->
            <div id="hero" class="jarallax" data-speed="0.7" data-img-position="50% 55%" style="background-image: url(../public/landing_assets/img/home_img/img_9.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <h1 class="__title"><span><?php echo $sys->sys_name; ?></span> Contact Us</h1>
                                ...
                                <div class="row justify-content-around">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3">
                                        <div class="__item">
                                            ...
                                            <p>
                                                523 Sylvan Ave, 5th Floor Mountain View, Katoloni, Machakos Kenya.
                                            </p>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3">
                                        <div class="__item">
                                            ...
                                            <p><a href="mailto:<?php echo $sys->sys_email; ?>"><?php echo $sys->sys_email; ?></a></p>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                </div>
            ...
            <!-- end main -->
        <?php }
        require_once('../partials/landing_footer.php'); ?>
