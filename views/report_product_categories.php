...
while ($sys = $res->fetch_object()) {
        ...
        <body style="margin:1px;">
            ...
            <table border="1" cellspacing="0" width="98%" style="font-size:9pt">
                ...
                ';
                    ...
                    <tr>
                        <td>' . $cnt . '</td>
                        <td width="100%">' . $categories->category_name . '</td>
                        <td width="90%">' . $categories->category_code . '</td>
                        <td width="100%">' . $categories->category_details . '</td>
                    </tr>
                    ';
                    $cnt = $cnt + 1;
                }
    ...
    $dompdf->render();
    $dompdf->stream('Product Categories', array("Attachment" => 1));
