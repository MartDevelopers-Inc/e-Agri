...
if (isset($_GET['delete'])) {
    ...
    $prepare->execute();
    if ($prepare) {
        $success = "Payment Deleted" && header('refresh:1; farmer_payments');
    } else {
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body text-center text-danger">
                                                                            ...
                                                                            <a href="farmer_payments?delete=<?php echo $products->payment_cart_id; ?>" class="text-center btn btn-danger"> Delete </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
