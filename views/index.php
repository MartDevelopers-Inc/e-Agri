    ...
    <div id="app">
                                    ...
                                    <ul>
                                        <li class="has-submenu active">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li class="active"><a href="index_4.html">Home Shop</a></li>
                                            </ul>
                                        </li>
        ...
        <div id="start-screen" class="start-screen start-screen--style-4 js-slick" data-slick='{
            ...
            <div class="start-screen__slide">
                <div class="start-screen__bg" style="background-image: url(../public/landing_assets/img/home_img/img_7.jpg);background-position: top 30% right 30%;"></div>
        ...
        <main role="main">
                        ...
                        <div class="__inner">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <a class="__item" href="#"><img src="../public/landing_assets/img/promo-banners_img/1.jpg" alt="demo" class="img-fluid w-100" /></a>
                                </div>

                                <div class="col-12 col-md-6 col-lg-4">
                                    <a class="__item" href="#"><img src="../public/landing_assets/img/promo-banners_img/2.jpg" alt="demo" class="img-fluid w-100" /></a>
                                </div>

                                <div class="col-12 col-md-6 col-lg-4">
                                    <a class="__item" href="#"><img src="../public/landing_assets/img/promo-banners_img/3.jpg" alt="demo" class="img-fluid w-100" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="js-slick" data-slick='{
                            ...
                            <div class="__item">
                                <figure class="__image">
                                    <img width="188" src="../public/landing_assets/img/goods_img/1.jpg" alt="demo" />
                                </figure>
                            ...
                            <div class="__item">
                                <figure class="__image">
                                    <img width="180" src="../public/landing_assets/img/goods_img/2.jpg" alt="demo" />
                                </figure>
                            ...
                            <div class="__item">
                                <figure class="__image">
                                    <img width="160" src="../public/landing_assets/img/goods_img/3.jpg" alt="demo" />
                                </figure>
                            ...
                            <div class="__item">
                                <figure class="__image">
                                    <img width="190" src="../public/landing_assets/img/goods_img/4.jpg" alt="demo" />
                                </figure>
                            ...
                            <div class="__item">
                                <figure class="__image">
                                    <img width="180" src="../public/landing_assets/img/goods_img/5.jpg" alt="demo" />
                                </figure>
                            ...
                            <div class="__item">
                                <figure class="__image">
                                    <img width="180" src="../public/landing_assets/img/goods_img/6.jpg" alt="demo" />
                                </figure>
                            ...
                            <div class="__item">
                                <figure class="__image">
                                    <img width="250" src="../public/landing_assets/img/goods_img/7.jpg" alt="demo" />
                                </figure>
                            ...
                            <div class="__item">
                                <figure class="__image">
                                    <img width="236" src="../public/landing_assets/img/goods_img/8.jpg" alt="demo" />
                                </figure>
                ...
                <div class="container-fluid px-md-0">
                    ...
                    <div class="simple-banner simple-banner--style-2" data-aos="fade" data-aos-offset="50">
                        <div class="d-none d-lg-block">
                            <img class="img-logo img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/site_logo.png" alt="demo" />
                        </div>

                        <div class="row no-gutters">
                            <div class="col-12 col-lg-6">
                                <a href="#"><img class="img-fluid w-100  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/banner_bg_3.jpg" alt="demo" /></a>
                            </div>

                            <div class="col-12 col-lg-6">
                                <a href="#"><img class="img-fluid w-100  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/banner_bg_4.jpg" alt="demo" /></a>
                            </div>
                        </div>
                    </div>
                    <!-- end banner simple -->
            ...
            <section class="section">
                <div class="d-none d-lg-block">
                    <img id="bg-img-1" class="img-fluid lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/agro_2.png" alt="demo" />
                    <style type="text/css">
                        #bg-img-1 {
                            position: absolute;
                            top: 50%;
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-5 col-lg-4">
                            <div class="section-heading section-heading--left" data-aos="fade">
                                <p>
                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/logo_small.png" width="50" height="50" alt="demo" />
                                </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3">
                                            <div class="__item  text-center" data-aos="fade" data-aos-delay="100" data-aos-offset="100">
                                                <i class="__ico">
                                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/feature_img/7.png" alt="demo" />
                                                </i>
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3">
                                            <div class="__item  text-center" data-aos="fade" data-aos-delay="200" data-aos-offset="100">
                                                <i class="__ico">
                                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/feature_img/8.png" alt="demo" />
                                                </i>
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3">
                                            <div class="__item  text-center" data-aos="fade" data-aos-delay="300" data-aos-offset="100">
                                                <i class="__ico">
                                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/feature_img/9.png" alt="demo" />
                                                </i>
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3">
                                            <div class="__item  text-center" data-aos="fade" data-aos-delay="400" data-aos-offset="100">
                                                <i class="__ico">
                                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/feature_img/10.png" alt="demo" />
                                                </i>
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3">
                                            <div class="__item  text-center" data-aos="fade" data-aos-delay="500" data-aos-offset="100">
                                                <i class="__ico">
                                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/feature_img/11.png" alt="demo" />
                                                </i>
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3">
                                            <div class="__item  text-center" data-aos="fade" data-aos-delay="600" data-aos-offset="100">
                                                <i class="__ico">
                                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/feature_img/12.png" alt="demo" />
                                                </i>
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3">
                                            <div class="__item  text-center" data-aos="fade" data-aos-delay="700" data-aos-offset="100">
                                                <i class="__ico">
                                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/feature_img/13.png" alt="demo" />
                                                </i>
                                        ...
                                        <div class="col-6 col-sm-4 col-lg-3">
                                            <div class="__item  text-center" data-aos="fade" data-aos-delay="800" data-aos-offset="100">
                                                <i class="__ico">
                                                    <img class="img-fluid  lazy" src="../public/landing_assets/img/blank.gif" data-src="../public/landing_assets/img/feature_img/14.png" alt="demo" />
                                                </i>
