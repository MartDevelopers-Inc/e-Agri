                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 col-sm-10 col-md-9 col-lg-9 col-xl-8">
                                    <h2 class="__title"><span>Get the</span> Fresh Food <span>from our</span><?php echo $sys->sys_name; ?></h2>

                                    <p>
                                        <span class="d-none d-sm-block"><a class="custom-btn custom-btn--big custom-btn--style-1" href="login">Discover</a></span>
                                        <span class="d-block d-sm-none"><a class="custom-btn custom-btn--small custom-btn--style-1" href="login">Discover</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center text-center">
                                <div class="col-12 col-md-9 col-lg-8 col-xl-7">
                                    <h2 class="__title text-white"><span>Fresh</span> Blueberries & Citrus <span>from <?php echo $sys->sys_name; ?></span></h2>


                                    <p class="mt-5 mt-md-8">
                                        <span class="d-none d-sm-block"><a class="custom-btn custom-btn--big custom-btn--style-3" href="login">Discover</a></span>
                                        <span class="d-block d-sm-none"><a class="custom-btn custom-btn--small custom-btn--style-3" href="login">Discover</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-lg">
                                        <div class="__item">
                                            ...
                                            <h4 class="__title h6">Free Shipping On Order Over Ksh 12000</h4>

                                            <span>Free shipping on all orders above 200 kgs</span>
                                        </div>
                                    </div>
                                    <!-- end item -->
