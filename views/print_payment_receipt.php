...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->sys_name . ' | ' . $sys->sys_tagine . ' Meals Report Generated On ' . date('d, M Y') . '</i>
            </div>
    ...
    while ($meals = $res->fetch_object()) {
        $html .=
            '
                <tr>
                    <td>' . $cnt . '</td>
                    <td width="40%">' . $meals->meal_name . '</td>
                    <td width="40%">' . $meals->category_name . '</td>
                    <td width="40%">Ksh ' . $meals->meal_price . '</td>
                    <td width="100%">' . $meals->meal_details . '</td>
                </tr>
                ';
        $cnt = $cnt + 1;
    }
    ...
    $dompdf->render();
    $dompdf->stream('Meal Reports', array("Attachment" => 1));
