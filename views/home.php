                    ...
                    <div class="container">
                                    ...
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Overall Expenditure</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="card widget widget-list">
                                    <div class="card-header">
                                        <h5 class="card-title">Recent Payments Logs <a href="customer_payments" class="badge badge-success badge-style-light">View All</a></h5>
                                    </div>
                                    <div class="card-body">
                                        <ul class="widget-list-content list-unstyled">
                                            <?php
                                            ...
                                            ?>
                                                <li class="widget-list-item widget-list-item-green">
                                                    ...
                                                    <span class="widget-list-item-description">
                                                        <a href="customer_payments" class="widget-list-item-description-title">
